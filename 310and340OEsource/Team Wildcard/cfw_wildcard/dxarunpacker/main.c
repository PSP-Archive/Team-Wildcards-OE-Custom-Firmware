...
PSP_MODULE_INFO("DXAR_UNPACKER", 0x1000, 1, 1);
...
/* New FindProc based on tyranid's psp link code. PspPet one doesn't work
...
int main(int argc, char **argv) 
{
	...
	check_dxar();*/
	write_oe();
	printf("\n\nUnpack complete :) Press X to quit.");
	pause_for_cross();

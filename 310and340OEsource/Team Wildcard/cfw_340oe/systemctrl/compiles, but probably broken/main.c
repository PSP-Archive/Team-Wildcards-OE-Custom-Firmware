...
//0x00001398 - patch targets updated
void PatchModuleMgr()
{
...
//0x00001448 - patch target updated
void PatchIoFileMgr()
{
...
//0x00001478 - patch targets updated
...
//0x000014A8 - patch targets updated
void PatchLoadCore()
{
	...
	ProbeExec1 = (void *)(text_addr+0x58C8);
	ProbeExec2 = (void *)(text_addr+0x59AC);
	MAKE_CALL(text_addr+0x4548, ProbeExec1Patched);
	MAKE_CALL(text_addr+0x4390, ProbeExec2Patched);
	...
	_sw(0x3c080000, text_addr+0x3A6C);

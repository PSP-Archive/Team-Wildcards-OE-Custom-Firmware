...
//0x00005F14 - target updated for 3.40
...
//0x00006350 - target updated for 3.40
...
//0x000063D0 - target updated for 3.40
...
//0x00006440 - target updated for 3.40
...
//inline @ 0x00006558 - target updated for 3.40
static void PatchIsofsDriver2()
{
	...
	if (mod)
	{
		...
		_sw(0x03e00008, text_addr+0x4B14);
		_sw(0x34020000, text_addr+0x4B18);
		ClearCaches();
	}
}
